...
@Component({
  selector: 'app-menu-herramientas-vertical',
  templateUrl: './menu-herramientas-vertical.component.html',
  styleUrls: ['./menu-herramientas-vertical.component.css']
})
export class MenuHerramientasVerticalComponent implements OnInit, AfterViewInit{
